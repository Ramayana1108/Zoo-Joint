          ...
          <div className="Auth-form-content-animal">
            ...
            <div className="form-group mt-3">
              ...
              <input
                type="text"
                name="animal_name"
                className={`form-control mt-1 ${!values.animal_name && animalInfoError !==""  ? 'is-invalid':  ''}`}
            ...
            <div className="form-group mt-3">
              <label>Scientific Name</label>
                <input
                  type="text"
                  name="animal_sciname"
                  className={`form-control mt-1 ${!values.animal_sciname && animalInfoError !==""? 'is-invalid':  ''}`}
            ...
            <div className="form-group mt-3">
              <label>Enclosure</label>
                <select
                  ...
                  className={`form-control mt-1 ${!values.animal_enclosure && animalInfoError !=="" ? 'is-invalid':  ''}`}
            ...
            <div className="form-group mt-3">
              <label>Animal Habitat</label>
                <input
                  type="text"
                  name="animal_habitat"
                  className={`form-control mt-1 ${!values.animal_habitat ? 'is-invalid' && animalInfoError !=="":  ''}`}
            ...
            <div className="form-group mt-3">
              <label>Description</label>
                <input
                  ...
                  className={`form-control mt-1 ${!values.animal_description && animalInfoError !==""? 'is-invalid':  ''}`}
              ...
              <div className="form-group mt-3">
                <label>Conservation Status</label>
                  <select
                    ...
                    className={`form-control mt-1 ${!values.animal_conservationstatus && animalInfoError !==""? 'is-invalid':  ''}`}
